...
public class OracleDAOFactory extends DAOFactory{
	 ...
	 public void AddCustomer(CustomerDAO cust)
	{
	    ...
	    int id = cust.getID();
	    map.put(id,name);
		System.out.println("Customer values inserted Successfully in ORACLE database with CustomerID: " + id);
	}
	...
	public void AddItem(ItemDAO item)
	{
	    ...
	    map1.put(id,name);
		System.out.println("Item values inserted Successfully in ORACLE database with ItemID :" + id);
	}
}
