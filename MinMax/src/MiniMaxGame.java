...
public class MiniMaxGame {
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.println("Part 1:MiniMaxGame board3.txt board4.txt 2");
			System.exit(0);
		}
		...
		else if(!args[1].equals("C:\\Users\\Rassu\\Desktop\\board5MM5.txt"))	// if the name of the output file is not board4.txt
		{
			System.out.println("Part 1: MiniMaxGame board3.txt board4.txt 2");
			System.exit(0);
		}
		depth=Integer.parseInt(args[2]);
		MiniMaxGame mmg = new MiniMaxGame();
		mmg.generateMidgameEndgame(args[0],args[1]);
		Link parent=L.first;
		int minimax_estimate=mmg.maxMin(parent,0);	
	...
	void generateMidgameEndgame(String in_file, String out_file) {
