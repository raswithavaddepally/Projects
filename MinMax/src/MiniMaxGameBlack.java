...
//To generate the Midgame and Endgame positions using minimax algorithm
public class MiniMaxGameBlack {

	static LinkList L = new LinkList();			// List that represent the minimax tree
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.println("Part 3: MiniMaxGameBlack board.txt board4.txt 2");
			System.exit(0);
		}
		else if(!args[0].equals("C:\\Users\\Rassu\\Desktop\\board7.txt"))	// if the name of the input file is not board3.txt
		{
			System.out.println("Part 3:MiniMaxGameBlack board3.txt board4.txt 2");
			System.exit(0);
		}
		else if(!args[1].equals("C:\\Users\\Rassu\\Desktop\\board7MMB1.txt"))	// if the name of the output file is not board4.txt
		{	
			System.out.println("Part 3:MiniMaxGameBlack board3.txt board4.txt 2");
			System.exit(0);
		}
		...
		MiniMaxGameBlack mmgb = new MiniMaxGameBlack();
		mmgb.generateMidgameEndgame(args[0],args[1]);
		Link parent=L.first;
		int minimax_estimate=mmgb.maxMin(parent,0);	
		...
		System.out.println("Position calculuated by static estimation is: " + pos_evaluated);
	...
	private int maxMin(Link temp, int d)
	{
		...
		else
		{
			...
			if(num_WhitePieces==3)
				temp.LL=generateHopping(temp.b_pos, temp.LL);
			else
				temp.LL=generateMove(temp.b_pos, temp.LL);
	...
	// To remove white piece from the board
