...
class LinkList {
  ...
  //Deletes the link at the start of the list
    public Link delete() {
	    Link temp = first;
...
//To generate the opening positions of white pieces using the minimax algorithm.
public class MiniMaxOpening {
	static LinkList L = new LinkList();			// List representing the minimax tree
	static int depth;							// Stores the value of the depth which is passed as command line arguement
	...
	{		
		...
		{
			System.out.println("Part 1: MiniMaxOPening board1.txt board2.txt 2");
			System.exit(0);
		}
		else if(!args[0].equals("C:\\Users\\Rassu\\Desktop\\board2.txt"))	// if the name of the input file is not board1.txt
		{
			System.out.println("Part 1: MiniMaxOPening board1.txt board2.txt depth(number)");
			System.exit(0);
		}
		else if(!args[1].equals("C:\\Users\\Rassu\\Desktop\\board2MMO2.txt"))	// if the name of the output file is not board2.txt
		{
			System.out.println("Part 1: MiniMaxOPening board1.txt board2.txt depth(number)");
			System.exit(0);
		}
		depth=Integer.parseInt(args[2]);
		MiniMaxOpening mmo = new MiniMaxOpening();
		mmo.generateMovesOpening(args[0],args[1]);
		Link parent=L.first;
		int minimax_estimate=mmo.maxMin(parent,0);			//Computes the minimax estimate
	...
	void generateMovesOpening(String in_file, String out_file) {
		...
		try{
			...
			System.out.println("Input board position:");
