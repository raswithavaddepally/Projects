...
public class MiniMaxOpeningImproved {
	...
	{		
		...
		{
			System.out.println("Part 4: MiniMaxOpeningImproved board1.txt board2.txt 2");
			System.exit(0);
		}
		else if(!args[0].equals("C:\\Users\\Rassu\\Desktop\\board1.txt"))	// if the name of the input file is not board1.txt
		{
			System.out.println("Part 4: MiniMaxOpeningImproved board1.txt board2.txt depth(number)");
			System.exit(0);
		}
		else if(!args[1].equals("C:\\Users\\Rassu\\Desktop\\board2.txt"))	// if the name of the output file is not board2.txt
		{
			System.out.println("Part 4: MiniMaxOpeningImproved board1.txt board2.txt depth(number)");
			System.exit(0);
		}
		depth=Integer.parseInt(args[2]);
		MiniMaxOpeningImproved mmoi = new MiniMaxOpeningImproved();
		mmoi.generateMovesOpening(args[0],args[1]);
		Link parent=L.first;
		int minimax_estimate=mmoi.maxMin(parent,0);			//Computes the minimax estimate
